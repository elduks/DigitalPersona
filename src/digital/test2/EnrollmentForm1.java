...
public class EnrollmentForm1 extends CaptureForm
{
	private DPFPEnrollment enroller = DPFPGlobal.getEnrollmentFactory().createEnrollment();
	
	EnrollmentForm1(Frame owner) {
		super(owner);
	}
		...
		if (features != null) try
		{
			...
			switch(enroller.getTemplateStatus())
			{
				...
				case TEMPLATE_STATUS_FAILED:	// report failure and restart capturing
					...
					JOptionPane.showMessageDialog(EnrollmentForm1.this, "The fingerprint template is not valid. Repeat fingerprint enrollment.", "Fingerprint Enrollment", JOptionPane.ERROR_MESSAGE);
					start();
					break;
			}
		}
